...
PMA_messages['strTableNameDialogMessage'] = "Please enter a valid table name.";
PMA_messages['strDBNameDialogMessage'] = "Please enter a valid database name.";
...
PMA_messages['strNoAutoSavedQuery'] = "No previously auto-saved query is available. Loading default query.";
PMA_messages['strPreviousSaveQuery'] = "You have a previously saved query. Click Get auto-saved query to load the query.";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">Some errors have been detected on the server!<br>Please look at the bottom of this window.<div><input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"Ignore\" class=\"btn btn-secondary floatright message_errors_found\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"Ignore All\" class=\"btn btn-secondary floatright message_errors_found\"></div></div>";
...
PMA_messages['strCopyQueryButtonSuccess'] = "Successfully copied!";
PMA_messages['strCopyQueryButtonFailure'] = "Copying failed!";
